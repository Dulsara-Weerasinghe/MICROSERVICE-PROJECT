 ...
 */
@Embeddable
public class LvmtWbSectionpagePK implements Serializable {
    ...
    public LvmtWbSectionpagePK() {
    }

    public LvmtWbSectionpagePK(String userrolecode, String sectioncode, String pagecode) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LvmtWbSectionpagePK)) {
            return false;
        }
        LvmtWbSectionpagePK other = (LvmtWbSectionpagePK) object;
    ...
    public String toString() {
        return "com.epic.department.service.entity.LvmtWbSectionpagePK[ userrolecode=" + userrolecode + ", sectioncode=" + sectioncode + ", pagecode=" + pagecode + " ]";
    }
