 ...
 */
@Embeddable
public class LvmtWbPagetaskPK implements Serializable {
    ...
    public LvmtWbPagetaskPK() {
    }

    public LvmtWbPagetaskPK(String userrolecode, String pagecode, String taskcode) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LvmtWbPagetaskPK)) {
            return false;
        }
        LvmtWbPagetaskPK other = (LvmtWbPagetaskPK) object;
    ...
    public String toString() {
        return "com.epic.department.service.entity.LvmtWbPagetaskPK[ userrolecode=" + userrolecode + ", pagecode=" + pagecode + ", taskcode=" + taskcode + " ]";
    }
