 ...
 */
@Embeddable
public class LvmtWbUserrolesectionPK implements Serializable {
    ...
    public LvmtWbUserrolesectionPK() {
    }

    public LvmtWbUserrolesectionPK(String userrolecode, String sectioncode) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof LvmtWbUserrolesectionPK)) {
            return false;
        }
        LvmtWbUserrolesectionPK other = (LvmtWbUserrolesectionPK) object;
    ...
    public String toString() {
        return "com.epic.department.service.entity.LvmtWbUserrolesectionPK[ userrolecode=" + userrolecode + ", sectioncode=" + sectioncode + " ]";
    }
